...
string. This function should be case insensitive so a lowercase letter and uppercase letter should count
...
function removeVowels(str) {
  let splitString = str.split("");
  const noVowels = splitString.filter(letter => {
    return (
      letter.toLowerCase() !== "a" &&
      letter.toLowerCase() !== "e" &&
      letter.toLowerCase() !== "i" &&
  ...
  return noVowels.join("").toLowerCase();
}
